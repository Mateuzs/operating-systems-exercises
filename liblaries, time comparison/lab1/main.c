...
//  lab1
//
//  Created by Mateusz Zembol on 10.03.2018.
...
int main(int argc, const char * argv[]) {
    ...
    void (*addDataToDynamicTable)(struct Table );
    void (*deleteAndAddRecords)(struct Table );
    void (*deleteThenAddOneByOne)(struct Table );
    void (*addDataToStaticTable)(struct StaticTable );
    void (*deleteAndAddRecordsInStaticTable)(struct StaticTable );
    void (*deleteThenAddOneByOneInStaticTable)(struct StaticTable );
    
    
    char *error;
    // Open the library
    handle = dlopen("/Users/mateuszzembol/Projekty-studia/SysOpy/lab1/lab1/libtableofblocks.so.1.0", RTLD_LAZY);
    if (!handle) {
        fprintf(stderr, "%s\n", dlerror());
        return 1;
    }
    ...
    addBlockToStaticTable = (void (*)(struct StaticTable, char[]))dlsym(handle,"addBlockToStaticTable");
    deleteBlockFromStaticTable = (void (*)(struct StaticTable, int))dlsym(handle, "deleteBlockFromStaticTable");
    deleteStaticTable = (void (*)(struct StaticTable))dlsym(handle,"deleteStaticTable");
    findClosestBlockInStaticTable = (char* (*)(struct StaticTable, int))dlsym(handle, "findClosestBlockInStaticTable");
    
    addDataToDynamicTable = (void (*)(struct Table))dlsym(handle, "addDataToDynamicTable");
    deleteAndAddRecords = (void (*)(struct Table))dlsym(handle, "deleteAndAddRecrds");
    deleteThenAddOneByOne = (void (*)(struct Table))dlsym(handle,"deleteThenAddOneByOne");
    addDataToStaticTable = (void (*)(struct StaticTable))dlsym(handle, "addDataToStaticTable");
    deleteAndAddRecordsInStaticTable = (void (*)(struct StaticTable))dlsym(handle, "deleteAndAddRecrdsInStaticTable");
    deleteThenAddOneByOneInStaticTable = (void (*)(struct StaticTable))dlsym(handle,"deleteThenAddOneByOneInStaticTable");
